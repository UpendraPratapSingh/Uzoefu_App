package com.travel.uzoefuapp.utils

import android.content.Context
import android.util.Log
import com.developer.kalert.KAlertDialog
import com.travel.uzoefuapp.R
import com.travel.uzoefuapp.extensions.getGsonInstance
...
object ErrorUtil {
    ...
    fun handlerGeneralError(context: Context?, throwable: Throwable): String {
        ...
        when (throwable) {
            //For Display
            is ConnectException -> errorDialogs(context, context.getString(R.string.unable_to_connect))

            is SocketTimeoutException -> errorDialogs(context, context.getString(R.string.unable_to_connect))

            is UnknownHostException -> errorDialogs(context, context.getString(R.string.unable_to_connect))
    ...
    fun displayError(context: Context, exception: HttpException): String {
        ...
        try {
            ...
            KAlertDialog(context, KAlertDialog.ERROR_TYPE)
                ...
                .confirmButtonColor(R.color.green_color)

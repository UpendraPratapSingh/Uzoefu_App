...
import com.travel.uzoefuapp.databinding.ActivitySelectUserTypeBinding
...
class SelectUserTypeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnBusiness.setOnClickListener {
            val intent =
                Intent(this@SelectUserTypeActivity, CreateBusinessAccountActivity::class.java)
            startActivity(intent)
        }

        binding.btnIndividual.setOnClickListener {
            val intent = Intent(this@SelectUserTypeActivity, CreateAccountActivity::class.java)
            startActivity(intent)
        }

...
class DestinationDetailAdapter(
    val context: Context,
    private val activityList: List<DestinationDetailResponse.Datum>,
    // private val wishlistClickListener: OnWishlistListener
) :
    RecyclerView.Adapter<DestinationDetailAdapter.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.destination_detail_recyclerview, parent, false)

...
class NotificationListViewModel @Inject constructor(
    ...
    val notificationListResponse = MutableLiveData<Event<NotificationListResponse>>()
    ...
    fun notificationListApi(
        ...
        viewModelScope.launch {
            notificationList(activity, progressDialog)
        }

    private suspend fun notificationList(
        activity: Activity,
        progressDialog: CustomProgressDialog,
    ) {
        ...
        repository.notificationList()
            ...
            .subscribe(object : DisposableObserver<NotificationListResponse>() {
                ...
                override fun onNext(value: NotificationListResponse) {
                    ...
                    notificationListResponse.value = Event(value)
                    progressDialog.stop()
                }
